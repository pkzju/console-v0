...
void FNavgationBar::setAlignment_topLeft()
{
    ...
    mainlayout_topLeft->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_topCenter()
{
    ...
    mainlayout_topCenter->addStretch();
    mainlayout_topCenter->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_topRight()
{
    ...
    mainlayout_topRight->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_bottomLeft()
{
    ...
    mainlayout_bottomLeft->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_bottomCenter()
{
    ...
    mainlayout_bottomCenter->addStretch();
    mainlayout_bottomCenter->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_bottomRight()
{
    ...
    mainlayout_bottomRight->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_leftTop()
{
    ...
    mainlayout_leftTop->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_leftCenter()
{
    ...
    mainlayout_leftCenter->addStretch();
    mainlayout_leftCenter->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_leftBottom()
{
    ...
    mainlayout_leftBottom->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_rightTop()
{
    ...
    mainlayout_rightTop->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_rightCenter()
{
    ...
    mainlayout_rightCenter->addStretch();
    mainlayout_rightCenter->setContentsMargins(1, 1, 1, 1);
...
void FNavgationBar::setAlignment_rightBottom()
{
    ...
    mainlayout_rightBottom->setContentsMargins(1, 1, 1, 1);
...
QList<FCheckabelButton*> FNavgationBar::getButtons()
{
    return buttons;
}
